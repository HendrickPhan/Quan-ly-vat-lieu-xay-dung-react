        ...
        <GridContainer>
            ...
            <GridItem xs={12} sm={12} md={12}>
                <MaterialTable
                    components={{
                        Pagination: pagimationProps => (
                            <TablePagination
                                ...
                                onChangePage={(e, page) => {
                                    props.fetchCategories(page + 1, props.perPage)
                                }}
                    ...
                    columns={[
                        { title: 'Id', field: 'id', type: 'numeric', cellStyle: { textAlign: 'left', width: 'cal(50% - 48px)' } },
                        { title: 'Tên danh mục', field: 'name', cellStyle: { textAlign: 'left', width: 'cal(50% - 48px)' } },
                    ]}
